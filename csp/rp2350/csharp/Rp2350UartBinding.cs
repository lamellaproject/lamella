// The descriptor an RP2350 PL011-UART driver consumes: one binding's resolved values, exactly
namespace Lamella.Boards
{
    public sealed class Rp2350UartBinding
    {
        ...
        /// <summary>The resolved PADS_BANK0 register of the TX pin (written to clear ISO).</summary>
        public readonly uint PadsTx;
        /// <summary>The resolved PADS_BANK0 register of the RX pin.</summary>
        public readonly uint PadsRx;
        ...
        public Rp2350UartBinding(uint uartBase, uint resetMask, uint ioTxCtrl, uint ioRxCtrl,
            uint padsTx, uint padsRx, uint funcsel, uint clkPeriHz)
        {
            UartBase = uartBase;
            ResetMask = resetMask;
            IoTxCtrl = ioTxCtrl;

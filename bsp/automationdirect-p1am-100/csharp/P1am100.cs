...
namespace Lamella.Boards.AutomationDirect
{
    public sealed class P1am100
    {
        ...
        public static readonly int BoardModel = AutomationdirectP1am100Bindings.BOARD_MODEL;
        ...
        public static readonly int LedPin =
            LogicalPin(AutomationdirectP1am100Bindings.LED_PORT_BASE, AutomationdirectP1am100Bindings.LED_PIN);
        ...
        public static readonly int RunSwitchPin =
            LogicalPin(AutomationdirectP1am100Bindings.RUN_SWITCH_PORT_BASE, AutomationdirectP1am100Bindings.RUN_SWITCH_PIN);
        ...
        public static readonly int BaseEnablePin =
            LogicalPin(AutomationdirectP1am100Bindings.BASE_ENABLE_PORT_BASE, AutomationdirectP1am100Bindings.BASE_ENABLE_PIN);
        ...
        public static readonly int BaseChipSelectPin =
            LogicalPin(AutomationdirectP1am100Bindings.BASE_CS_PORT_BASE, AutomationdirectP1am100Bindings.BASE_CS_PIN);
        ...
        public static readonly int BaseReadyPin =
            LogicalPin(AutomationdirectP1am100Bindings.BASE_READY_PORT_BASE, AutomationdirectP1am100Bindings.BASE_READY_PIN);

...
//
// The automationdirect-p1am-100 board bindings as Swift constants, name/value-identical to AutomationdirectP1am100Bindings.g.cs:
// every value below is a generation-time literal derived from the strata. The board's
// facts are stated in board.toml.

public enum AutomationdirectP1am100Bindings {
    // -- identity --

...
//!
//! The st-nucleo-l053r8 board bindings as Rust consts, name/value-identical to StNucleoL053r8Bindings.g.cs:
//! every value below is a generation-time literal derived from the strata.
//! The board's facts are stated in board.toml.

// -- identity --
pub const BOARD_MODEL: u16 = 41;
...
pub const VCP_DRIVER_FAMILY: &str = "stm32l053-usart";
pub const BUTTON_DRIVER_FAMILY: &str = "stm32l053-exti";

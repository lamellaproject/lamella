...
//
// The st-nucleo-l053r8 board bindings as Swift constants, name/value-identical to StNucleoL053r8Bindings.g.cs:
// every value below is a generation-time literal derived from the strata. The board's
// facts are stated in board.toml.

public enum StNucleoL053r8Bindings {
    // -- identity --
    ...
    public static let DEVICE_COUNT: UInt32 = 0
}

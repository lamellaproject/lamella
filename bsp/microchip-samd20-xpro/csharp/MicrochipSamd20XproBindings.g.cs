...
//
// The microchip-samd20-xpro board bindings (resolved against the samd20 chip strata): every value below is a
...
{
    public sealed class MicrochipSamd20XproBindings
    {
        private MicrochipSamd20XproBindings() { }

...
//!
//! The microchip-samd20-xpro board bindings as Rust consts, name/value-identical to MicrochipSamd20XproBindings.g.cs:
//! every value below is a generation-time literal derived from the strata.
//! The board's facts are stated in board.toml.

// -- identity --
pub const BOARD_MODEL: u16 = 48;
...
pub const VCP_DRIVER_FAMILY: &str = "samd20-sercom";
...
pub const VCP_PMUX_REG: u32 = 0x4100443C;
pub const VCP_PMUX_PAIR: u32 = 0x22;
pub const VCP_PMUX_TX_REG: u32 = 0x4100443C;
pub const VCP_PMUX_TX_MASK: u32 = 0xF;
pub const VCP_PMUX_TX_VALUE: u32 = 0x2;
pub const VCP_PMUX_RX_REG: u32 = 0x4100443C;
pub const VCP_PMUX_RX_MASK: u32 = 0xF0;
pub const VCP_PMUX_RX_VALUE: u32 = 0x20;
pub const VCP_PINCFG_TX_REG: u32 = 0x41004458;
pub const VCP_PINCFG_RX_REG: u32 = 0x41004459;

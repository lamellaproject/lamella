...
//
// The microchip-same51-cnano board bindings (resolved against the same54 chip strata): every value below is a
...
{
    public sealed class MicrochipSame51CnanoBindings
    {
        private MicrochipSame51CnanoBindings() { }

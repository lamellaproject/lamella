...
namespace Lamella.Boards.Microchip
{
    public sealed class Same51Cnano
    {
        ...
        public static readonly int BoardModel = MicrochipSame51CnanoBindings.BOARD_MODEL;
        ...
        public static readonly int LedPin =
            Same54GpioDriver.LogicalPin(MicrochipSame51CnanoBindings.LED0_PORT_BASE, MicrochipSame51CnanoBindings.LED0_PIN);
        ...
        public static readonly int ButtonPin =
            Same54GpioDriver.LogicalPin(MicrochipSame51CnanoBindings.BUTTON0_PORT_BASE, MicrochipSame51CnanoBindings.BUTTON0_PIN);

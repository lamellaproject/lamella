// GENERATED by lamella-bsp-gen from bsp/microchip-same51-cnano/board.toml + csp/same54/ strata -- DO NOT EDIT.
// Regenerate: cargo run -p lamella-bsp-gen -- gen-family . same54
//
// The microchip-same51-cnano board bindings as Swift constants, name/value-identical to MicrochipSame51CnanoBindings.g.cs:
// every value below is a generation-time literal derived from the strata. The board's
// facts are stated in board.toml.

public enum MicrochipSame51CnanoBindings {
    // -- identity --

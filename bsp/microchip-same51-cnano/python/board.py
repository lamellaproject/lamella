...
# own idiom.
DEVICES = {
    "led0": {"kind": "gpio-out", "port_base": 0x41008000, "pin": 14, "bank": 0, "mask": 0x4000, "active_low": False},
    "button0": {"kind": "gpio-in", "port_base": 0x41008000, "pin": 15, "bank": 0, "mask": 0x8000, "active_low": True},
}

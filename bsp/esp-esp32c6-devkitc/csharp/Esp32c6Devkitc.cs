...
namespace Lamella.Boards.Espressif
{
    public sealed class Esp32c6Devkitc
    {
        ...
        public static readonly int BoardModel = EspEsp32c6DevkitcBindings.BOARD_MODEL;
        ...
        public Esp32C6Uart CreateUart()
        {
            return new Esp32C6Uart(new Esp32C6UartBinding(
                EspEsp32c6DevkitcBindings.UART0_BASE,
                EspEsp32c6DevkitcBindings.UART0_PCR_CONF,
                EspEsp32c6DevkitcBindings.UART0_PCR_SCLK_CONF,
                EspEsp32c6DevkitcBindings.UART0_IO_MUX_TX,
                EspEsp32c6DevkitcBindings.UART0_IO_MUX_RX,
                EspEsp32c6DevkitcBindings.UART0_MCU_SEL,
                EspEsp32c6DevkitcBindings.UART0_SCLK_HZ));
        }

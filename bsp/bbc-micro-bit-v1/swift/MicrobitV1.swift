...
// from the GENERATED BbcMicroBitV1Bindings constants, and carries the one board fact the strata
...
public struct MicroBitV1Display {
    ...
    static func drive(_ i: Int) -> Nrf51PinBinding {
        switch i {
        case 0: return Nrf51PinBinding(portBase: BbcMicroBitV1Bindings.DISPLAY_ROW1_PORT_BASE,
                                       mask: BbcMicroBitV1Bindings.DISPLAY_ROW1_MASK,
                                       activeLow: BbcMicroBitV1Bindings.DISPLAY_ROW1_ACTIVE_LOW == 1)
        case 1: return Nrf51PinBinding(portBase: BbcMicroBitV1Bindings.DISPLAY_ROW2_PORT_BASE,
                                       mask: BbcMicroBitV1Bindings.DISPLAY_ROW2_MASK,
                                       activeLow: BbcMicroBitV1Bindings.DISPLAY_ROW2_ACTIVE_LOW == 1)
        default: return Nrf51PinBinding(portBase: BbcMicroBitV1Bindings.DISPLAY_ROW3_PORT_BASE,
                                        mask: BbcMicroBitV1Bindings.DISPLAY_ROW3_MASK,
                                        activeLow: BbcMicroBitV1Bindings.DISPLAY_ROW3_ACTIVE_LOW == 1)
        }
    }
    ...
    static func sink(_ i: Int) -> Nrf51PinBinding {
        switch i {
        case 0: return pin(BbcMicroBitV1Bindings.DISPLAY_COL1_MASK)
        case 1: return pin(BbcMicroBitV1Bindings.DISPLAY_COL2_MASK)
        case 2: return pin(BbcMicroBitV1Bindings.DISPLAY_COL3_MASK)
        case 3: return pin(BbcMicroBitV1Bindings.DISPLAY_COL4_MASK)
        case 4: return pin(BbcMicroBitV1Bindings.DISPLAY_COL5_MASK)
        case 5: return pin(BbcMicroBitV1Bindings.DISPLAY_COL6_MASK)
        case 6: return pin(BbcMicroBitV1Bindings.DISPLAY_COL7_MASK)
        case 7: return pin(BbcMicroBitV1Bindings.DISPLAY_COL8_MASK)
        default: return pin(BbcMicroBitV1Bindings.DISPLAY_COL9_MASK)
        }
    }
    ...
    private static func pin(_ mask: UInt32) -> Nrf51PinBinding {
        Nrf51PinBinding(portBase: BbcMicroBitV1Bindings.DISPLAY_COL1_PORT_BASE,
                        mask: mask,
                        activeLow: BbcMicroBitV1Bindings.DISPLAY_COL1_ACTIVE_LOW == 1)
    }
...
func spinDelay(_ count: UInt32) {
    ...
    while i < count {
        i &+= 1
        _ = Mmio.read32(BbcMicroBitV1Bindings.DISPLAY_ROW1_PORT_BASE + Nrf51GpioLayout.IN_OFF)
    }
}

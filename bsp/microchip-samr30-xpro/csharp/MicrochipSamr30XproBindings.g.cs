...
//
// The microchip-samr30-xpro board bindings (resolved against the samr30 chip strata): every value below is a
...
{
    public sealed class MicrochipSamr30XproBindings
    {
        private MicrochipSamr30XproBindings() { }

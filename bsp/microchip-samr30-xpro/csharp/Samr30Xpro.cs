...
namespace Lamella.Boards.Microchip
{
    public sealed class Samr30Xpro
    {
        ...
        public static readonly int BoardModel = MicrochipSamr30XproBindings.BOARD_MODEL;
        ...
        public static readonly int Led0Pin =
            Samr30GpioDriver.LogicalPin(MicrochipSamr30XproBindings.LED0_PORT_BASE, MicrochipSamr30XproBindings.LED0_PIN);

        /// <summary>The green user LED LED1 on PA18, ACTIVE LOW: it lights when driven
        /// <see cref="PinValue.Low"/>.</summary>
        public static readonly int Led1Pin =
            Samr30GpioDriver.LogicalPin(MicrochipSamr30XproBindings.LED1_PORT_BASE, MicrochipSamr30XproBindings.LED1_PIN);
        ...
        public static readonly int ButtonPin =
            Samr30GpioDriver.LogicalPin(MicrochipSamr30XproBindings.BUTTON0_PORT_BASE, MicrochipSamr30XproBindings.BUTTON0_PIN);

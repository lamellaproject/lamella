...
//
// The microchip-atsamd10-xmini board bindings as Swift constants, name/value-identical to MicrochipAtsamd10XminiBindings.g.cs:
// every value below is a generation-time literal derived from the strata. The board's
// facts are stated in board.toml.

public enum MicrochipAtsamd10XminiBindings {
    // -- identity --

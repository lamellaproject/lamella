...
//
// The microchip-samr21-xpro board bindings (resolved against the samr21 chip strata): every value below is a
...
{
    public sealed class MicrochipSamr21XproBindings
    {
        private MicrochipSamr21XproBindings() { }

...
FACTS = {
    "vcp": {
        ...
        "pmux_reg": 0x41004432,
        "pmux_pair": 0x33,
        "pmux_tx_reg": 0x41004432,
        "pmux_tx_mask": 0xF,
        "pmux_tx_value": 0x3,
        "pmux_rx_reg": 0x41004432,
        "pmux_rx_mask": 0xF0,
        "pmux_rx_value": 0x30,
        "pincfg_tx_reg": 0x41004444,
        "pincfg_rx_reg": 0x41004445,
        "txpo": 0,
        "rxpo": 1,
...
INSTANCES = {
    ...
    "portc": {"block": "port", "base": 0x41004500},
}
...
# own idiom.
DEVICES = {
    "led0": {"kind": "gpio-out", "port_base": 0x41004400, "pin": 19, "bank": 0, "mask": 0x80000, "active_low": True},
    "button0": {"kind": "gpio-in", "port_base": 0x41004400, "pin": 28, "bank": 0, "mask": 0x10000000, "active_low": True},
}

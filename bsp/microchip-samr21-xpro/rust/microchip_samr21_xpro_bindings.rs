//! GENERATED by lamella-bsp-gen from bsp/microchip-samr21-xpro/board.toml + csp/samr21/ strata -- DO NOT EDIT.
//! Regenerate: cargo run -p lamella-bsp-gen -- gen-family . samr21
//!
//! The microchip-samr21-xpro board bindings as Rust consts, name/value-identical to MicrochipSamr21XproBindings.g.cs:
...
pub const VCP_PMUX_TX_REG: u32 = 0x41004432;
pub const VCP_PMUX_TX_MASK: u32 = 0xF;
pub const VCP_PMUX_TX_VALUE: u32 = 0x3;
pub const VCP_PMUX_RX_REG: u32 = 0x41004432;

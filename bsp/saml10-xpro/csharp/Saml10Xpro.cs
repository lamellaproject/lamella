...
namespace Lamella.Boards.Microchip
{
    public sealed class Saml10Xpro
    {
        ...
        public static readonly int BoardModel = Saml10XproBindings.BOARD_MODEL;
        ...
        public static readonly int LedPin =
            Saml1xGpioDriver.LogicalPin(Saml10XproBindings.LED0_PORT_BASE, Saml10XproBindings.LED0_PIN);
        ...
        public static readonly int ButtonPin =
            Saml1xGpioDriver.LogicalPin(Saml10XproBindings.BUTTON0_PORT_BASE, Saml10XproBindings.BUTTON0_PIN);

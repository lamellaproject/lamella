...
//
// The adafruit-feather-rp2040-adalogger board bindings as Swift constants, name/value-identical to AdafruitFeatherRp2040AdaloggerBindings.g.cs:
// every value below is a generation-time literal derived from the strata. The board's
// facts are stated in board.toml.

public enum AdafruitFeatherRp2040AdaloggerBindings {
    // -- identity --

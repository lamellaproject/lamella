...
//!
//! The adafruit-feather-rp2040-adalogger board bindings as Rust consts, name/value-identical to AdafruitFeatherRp2040AdaloggerBindings.g.cs:
...
pub const CONNECTOR_QT_SDA_BANK: u32 = 0;
...
pub const CONNECTOR_QT_SCL_BANK: u32 = 0;

...
//
// The microchip-atsamd11-xpro board bindings as Swift constants, name/value-identical to MicrochipAtsamd11XproBindings.g.cs:
// every value below is a generation-time literal derived from the strata. The board's
// facts are stated in board.toml.

public enum MicrochipAtsamd11XproBindings {
    // -- identity --

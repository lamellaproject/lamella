...
//
// The microchip-samha1g17a-xpro board bindings as Swift constants, name/value-identical to MicrochipSamha1g17aXproBindings.g.cs:
// every value below is a generation-time literal derived from the strata. The board's
// facts are stated in board.toml.

public enum MicrochipSamha1g17aXproBindings {
    // -- identity --
    public static let BOARD_MODEL: UInt16 = 51

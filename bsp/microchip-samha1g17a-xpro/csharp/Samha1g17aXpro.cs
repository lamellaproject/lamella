// Lamella.Boards.Microchip.Samha1g17aXpro -- the SAMHA1G17A Xplained Pro (order code EV47P31A).
...
{
    public sealed class Samha1g17aXpro
    {
        /// <summary>The wire identity this board advertises (lamella_wire::product_model).</summary>
        public static readonly int BoardModel = MicrochipSamha1g17aXproBindings.BOARD_MODEL;
        ...
        /// 32.768 kHz crystal, so nothing is in contention here.</remarks>
        public static readonly int LedPin =
            Samha1GpioDriver.LogicalPin(MicrochipSamha1g17aXproBindings.LED0_PORT_BASE, MicrochipSamha1g17aXproBindings.LED0_PIN);
        ...
        public static readonly int ButtonPin =
            Samha1GpioDriver.LogicalPin(MicrochipSamha1g17aXproBindings.BUTTON0_PORT_BASE, MicrochipSamha1g17aXproBindings.BUTTON0_PIN);

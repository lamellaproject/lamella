...
BOARD = "microchip-samha1g17a-xpro"
BOARD_MODEL = 51
...
FACTS = {
    "vcp": {
        ...
        "irq": 10,
        "gclk_clkctrl_value": 0x4015,
        "apbc_mask": 0x8,
        "pmux_tx_reg": 0x4100443D,
        "pmux_tx_mask": 0xF0,
        "pmux_tx_value": 0x20,
        "pmux_rx_reg": 0x4100443E,
        "pmux_rx_mask": 0xF,
        "pmux_rx_value": 0x2,
        "pincfg_tx_reg": 0x4100445B,
        "pincfg_rx_reg": 0x4100445C,
        "txpo": 0,
        "rxpo": 1,
...
# own idiom.
DEVICES = {
    "led0": {"kind": "gpio-out", "port_base": 0x41004400, "pin": 0, "bank": 0, "mask": 0x1, "active_low": True},
    "button0": {"kind": "gpio-in", "port_base": 0x41004480, "pin": 3, "bank": 0, "mask": 0x8, "active_low": True},
}

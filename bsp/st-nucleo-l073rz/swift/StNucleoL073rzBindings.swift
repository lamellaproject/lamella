...
//
// The st-nucleo-l073rz board bindings as Swift constants, name/value-identical to StNucleoL073rzBindings.g.cs:
// every value below is a generation-time literal derived from the strata. The board's
// facts are stated in board.toml.

public enum StNucleoL073rzBindings {
    // -- identity --
    public static let BOARD_MODEL: UInt16 = 44
    ...
    public static let VCP_DRIVER_FAMILY: String = "stm32l073-usart"

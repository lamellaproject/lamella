...
namespace Lamella.Boards.Microchip
{
    public sealed class Samd21Cnano
    {
        ...
        public static readonly int BoardModel = MicrochipSamd21CnanoBindings.BOARD_MODEL;
        ...
        public static readonly int LedPin =
            Samd21GpioDriver.LogicalPin(MicrochipSamd21CnanoBindings.LED0_PORT_BASE, MicrochipSamd21CnanoBindings.LED0_PIN);
        ...
        public static readonly int ButtonPin =
            Samd21GpioDriver.LogicalPin(MicrochipSamd21CnanoBindings.BUTTON0_PORT_BASE, MicrochipSamd21CnanoBindings.BUTTON0_PIN);

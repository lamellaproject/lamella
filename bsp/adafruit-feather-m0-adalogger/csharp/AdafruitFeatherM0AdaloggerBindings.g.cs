...
//
// The adafruit-feather-m0-adalogger board bindings (resolved against the samd21 chip strata): every value below is a
...
{
    public sealed class AdafruitFeatherM0AdaloggerBindings
    {
        private AdafruitFeatherM0AdaloggerBindings() { }

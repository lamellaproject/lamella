...
//
// The arduino-zero board bindings as Swift constants, name/value-identical to ArduinoZeroBindings.g.cs:
// every value below is a generation-time literal derived from the strata. The board's
// facts are stated in board.toml.

public enum ArduinoZeroBindings {
    // -- identity --
    ...
    public static let VCP_PMUX_TX_REG: UInt32 = 0x410044BB
    public static let VCP_PMUX_TX_MASK: UInt32 = 0xF
    public static let VCP_PMUX_TX_VALUE: UInt32 = 0x3
    public static let VCP_PMUX_RX_REG: UInt32 = 0x410044BB

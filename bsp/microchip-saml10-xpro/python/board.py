...
# own idiom.
DEVICES = {
    "led0": {"kind": "gpio-out", "port_base": 0x40003000, "pin": 7, "bank": 0, "mask": 0x80, "active_low": True},
    "button0": {"kind": "gpio-in", "port_base": 0x40003000, "pin": 27, "bank": 0, "mask": 0x8000000, "active_low": True},
}

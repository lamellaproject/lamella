// Lamella.Boards.Microchip.Saml10Xpro -- the SAM L10 Xplained Pro (ATSAML10-XPRO, ATSAML10E16A).
...
{
    public sealed class Saml10Xpro
    {
        /// <summary>The wire identity this board advertises (lamella_wire::product_model).</summary>
        public static readonly int BoardModel = MicrochipSaml10XproBindings.BOARD_MODEL;
        ...
        public static readonly int LedPin =
            Saml1xGpioDriver.LogicalPin(MicrochipSaml10XproBindings.LED0_PORT_BASE, MicrochipSaml10XproBindings.LED0_PIN);
        ...
        public static readonly int ButtonPin =
            Saml1xGpioDriver.LogicalPin(MicrochipSaml10XproBindings.BUTTON0_PORT_BASE, MicrochipSaml10XproBindings.BUTTON0_PIN);
        ...
        /// <summary>A GPIO controller over the SAM L10's PORT block.</summary>

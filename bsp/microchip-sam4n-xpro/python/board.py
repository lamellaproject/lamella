...
# own idiom.
DEVICES = {
    "led0": {"kind": "gpio-out", "port_base": 0x400E1000, "pin": 14, "mask": 0x4000, "active_low": True},
    "button0": {"kind": "gpio-in", "port_base": 0x400E0E00, "pin": 30, "mask": 0x40000000, "active_low": True},
}

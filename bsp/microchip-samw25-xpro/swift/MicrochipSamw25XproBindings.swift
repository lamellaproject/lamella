// GENERATED by lamella-bsp-gen from bsp/microchip-samw25-xpro/board.toml + csp/samw25/module.toml + csp/samd21/ strata -- DO NOT EDIT.
// Regenerate: cargo run -p lamella-bsp-gen -- gen-family . samd21
//
// The microchip-samw25-xpro board bindings as Swift constants, name/value-identical to MicrochipSamw25XproBindings.g.cs:
// every value below is a generation-time literal derived from the strata. The board's
// facts are stated in board.toml.

public enum MicrochipSamw25XproBindings {
    // -- identity --
    ...
    public static let DEVICE_COUNT: UInt32 = 3

...
//
// The microchip-samw25-xpro board bindings (resolved against the samd21 chip strata): every value below is a
...
{
    public sealed class MicrochipSamw25XproBindings
    {
        private MicrochipSamw25XproBindings() { }
        ...
        public const uint VCP_PMUX_TX_REG = 0x410044B5;
        public const uint VCP_PMUX_TX_MASK = 0xF;
        public const uint VCP_PMUX_TX_VALUE = 0x3;
        public const uint VCP_PMUX_RX_REG = 0x410044B5;

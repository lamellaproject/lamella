...
namespace Lamella.Boards.Microchip
{
    public sealed class Samw25Xpro
    {
        ...
        public static readonly int BoardModel = MicrochipSamw25XproBindings.BOARD_MODEL;
        ...
        public Samd21Uart CreateVcpUart()
        {
            return new Samd21Uart(new Samd21SercomUsartBinding(
                MicrochipSamw25XproBindings.VCP_SERCOM_BASE,
                MicrochipSamw25XproBindings.VCP_GCLK_CLKCTRL_VALUE,
                MicrochipSamw25XproBindings.VCP_APBC_MASK,
                MicrochipSamw25XproBindings.VCP_PMUX_REG,
                MicrochipSamw25XproBindings.VCP_PMUX_PAIR,
                MicrochipSamw25XproBindings.VCP_PINCFG_TX_REG,
                MicrochipSamw25XproBindings.VCP_PINCFG_RX_REG,
                MicrochipSamw25XproBindings.VCP_TXPO,
                MicrochipSamw25XproBindings.VCP_RXPO,
                MicrochipSamw25XproBindings.VCP_BAUD_115200_OSC8M_8MHZ));
        }
    }
}

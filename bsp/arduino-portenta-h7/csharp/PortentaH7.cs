...
namespace Lamella.Boards.Arduino
{
    public sealed class PortentaH7
    {
        ...
        public static readonly int BoardModel = ArduinoPortentaH7Bindings.BOARD_MODEL;
        ...
        public static readonly int LedRedPin =
            Stm32h7GpioDriver.LogicalPin(ArduinoPortentaH7Bindings.LED_RED_PORT_BASE, ArduinoPortentaH7Bindings.LED_RED_PIN);

        /// <summary>The green leg of DL1, ACTIVE LOW.</summary>
        public static readonly int LedGreenPin =
            Stm32h7GpioDriver.LogicalPin(ArduinoPortentaH7Bindings.LED_GREEN_PORT_BASE, ArduinoPortentaH7Bindings.LED_GREEN_PIN);

        /// <summary>The blue leg of DL1, ACTIVE LOW.</summary>
        public static readonly int LedBluePin =
            Stm32h7GpioDriver.LogicalPin(ArduinoPortentaH7Bindings.LED_BLUE_PORT_BASE, ArduinoPortentaH7Bindings.LED_BLUE_PIN);

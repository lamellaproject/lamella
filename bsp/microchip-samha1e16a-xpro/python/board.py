...
# own idiom.
DEVICES = {
    "led0": {"kind": "gpio-out", "port_base": 0x41004400, "pin": 17, "mask": 0x20000, "active_low": True},
    "button0": {"kind": "gpio-in", "port_base": 0x41004400, "pin": 18, "mask": 0x40000, "active_low": True},
}

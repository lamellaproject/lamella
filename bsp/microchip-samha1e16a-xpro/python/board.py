...
BOARD = "microchip-samha1e16a-xpro"
BOARD_MODEL = 52
...
FACTS = {
    "vcp": {
        ...
        "pmux_reg": 0x41004437,
        "pmux_pair": 0x33,
        "pmux_tx_reg": 0x41004437,
        "pmux_tx_mask": 0xF,
        "pmux_tx_value": 0x3,
        "pmux_rx_reg": 0x41004437,
        "pmux_rx_mask": 0xF0,
        "pmux_rx_value": 0x30,
        "pincfg_tx_reg": 0x4100444E,
        "pincfg_rx_reg": 0x4100444F,
        "txpo": 1,
        "rxpo": 3,
...
# own idiom.
DEVICES = {
    "led0": {"kind": "gpio-out", "port_base": 0x41004400, "pin": 17, "bank": 0, "mask": 0x20000, "active_low": True},
    "button0": {"kind": "gpio-in", "port_base": 0x41004400, "pin": 18, "bank": 0, "mask": 0x40000, "active_low": True},
}

// GENERATED by lamella-bsp-gen from bsp/microchip-samha1e16a-xpro/board.toml + csp/samha1/ strata -- DO NOT EDIT.
// Regenerate: cargo run -p lamella-bsp-gen -- gen-family . samha1
//
// The microchip-samha1e16a-xpro board bindings as Swift constants, name/value-identical to MicrochipSamha1e16aXproBindings.g.cs:
// every value below is a generation-time literal derived from the strata. The board's
// facts are stated in board.toml.

public enum MicrochipSamha1e16aXproBindings {
    // -- identity --
    public static let BOARD_MODEL: UInt16 = 52
    ...
    public static let VCP_DRIVER_FAMILY: String = "samha1-sercom"
    ...
    public static let VCP_PMUX_REG: UInt32 = 0x41004437
    public static let VCP_PMUX_PAIR: UInt32 = 0x33
    public static let VCP_PMUX_TX_REG: UInt32 = 0x41004437
    public static let VCP_PMUX_TX_MASK: UInt32 = 0xF
    public static let VCP_PMUX_TX_VALUE: UInt32 = 0x3
    public static let VCP_PMUX_RX_REG: UInt32 = 0x41004437
    public static let VCP_PMUX_RX_MASK: UInt32 = 0xF0
    public static let VCP_PMUX_RX_VALUE: UInt32 = 0x30
    public static let VCP_PINCFG_TX_REG: UInt32 = 0x4100444E
    public static let VCP_PINCFG_RX_REG: UInt32 = 0x4100444F
    ...
    public static let LED0_PIN: UInt32 = 17
    public static let LED0_MASK: UInt32 = 0x20000
    public static let LED0_ACTIVE_LOW: UInt32 = 1
    public static let BUTTON0_PORT_BASE: UInt32 = 0x41004400
    public static let BUTTON0_PIN: UInt32 = 18
    public static let BUTTON0_MASK: UInt32 = 0x40000

...
namespace Lamella.Boards.Microchip
{
    public sealed class Same54Xpro
    {
        ...
        public static readonly int BoardModel = MicrochipSame54XproBindings.BOARD_MODEL;
        ...
        public static readonly int LedPin =
            Same54GpioDriver.LogicalPin(MicrochipSame54XproBindings.LED0_PORT_BASE, MicrochipSame54XproBindings.LED0_PIN);
        ...
        public static readonly int ButtonPin =
            Same54GpioDriver.LogicalPin(MicrochipSame54XproBindings.BUTTON0_PORT_BASE, MicrochipSame54XproBindings.BUTTON0_PIN);
        ...
        public Same54SercomI2cBinding Ext1I2cBinding()
        {
            return new Same54SercomI2cBinding(
                MicrochipSame54XproBindings.EXT1_I2C_SERCOM_BASE,
                MicrochipSame54XproBindings.EXT1_I2C_GCLK_PCHCTRL_REG,
                MicrochipSame54XproBindings.EXT1_I2C_GCLK_PCHCTRL_VALUE,
                MicrochipSame54XproBindings.EXT1_I2C_APB_MASK_REG,
                MicrochipSame54XproBindings.EXT1_I2C_APB_MASK,
                MicrochipSame54XproBindings.EXT1_I2C_PMUX_REG,
                MicrochipSame54XproBindings.EXT1_I2C_PMUX_PAIR,
                MicrochipSame54XproBindings.EXT1_I2C_PINCFG_SDA_REG,
                MicrochipSame54XproBindings.EXT1_I2C_PINCFG_SCL_REG,
                MicrochipSame54XproBindings.EXT1_I2C_CORE_CLOCK_HZ);
        }
        ...
        public Same54AdcBinding Ext1AdcBinding()
        {
            return new Same54AdcBinding(
                ...
                MicrochipSame54XproBindings.EXT1_ADC_P_NVM_CALIB_AREA,
                MicrochipSame54XproBindings.EXT1_ADC_P_NVM_CALIB_LSB,
                MicrochipSame54XproBindings.EXT1_ADC_P_PMUX_REG,
                MicrochipSame54XproBindings.EXT1_ADC_P_PMUX_MASK,
                MicrochipSame54XproBindings.EXT1_ADC_P_PMUX_VALUE,
                MicrochipSame54XproBindings.EXT1_ADC_P_PINCFG_REG,
                MicrochipSame54XproBindings.EXT1_ADC_P_MUXPOS,

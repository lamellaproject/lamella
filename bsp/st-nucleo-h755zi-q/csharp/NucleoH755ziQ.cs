...
namespace Lamella.Boards.St
{
    public sealed class NucleoH755ziQ
    {
        ...
        public static readonly int BoardModel = StNucleoH755ziQBindings.BOARD_MODEL;

        /// <summary>The green user LED LD1.</summary>
        public static readonly int Led1Pin =
            Stm32h7GpioDriver.LogicalPin(StNucleoH755ziQBindings.LED0_PORT_BASE, StNucleoH755ziQBindings.LED0_PIN);

        /// <summary>The blue user LED LD2 -- on a DIFFERENT port from the other two.</summary>
        public static readonly int Led2Pin =
            Stm32h7GpioDriver.LogicalPin(StNucleoH755ziQBindings.LED1_PORT_BASE, StNucleoH755ziQBindings.LED1_PIN);

        /// <summary>The red user LED LD3.</summary>
        public static readonly int Led3Pin =
            Stm32h7GpioDriver.LogicalPin(StNucleoH755ziQBindings.LED2_PORT_BASE, StNucleoH755ziQBindings.LED2_PIN);

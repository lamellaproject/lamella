...
//
// The microchip-samc21n-xpro board bindings (resolved against the samc21 chip strata): every value below is a
...
{
    public sealed class MicrochipSamc21nXproBindings
    {
        private MicrochipSamc21nXproBindings() { }

        // -- identity --
        public const int BOARD_MODEL = 54;
        ...
        public const uint LED0_PORT_BASE = 0x41000100;
        public const uint LED0_PIN = 5;
        public const uint LED0_MASK = 0x20;
        public const uint LED0_ACTIVE_LOW = 1;
        public const uint BUTTON0_PORT_BASE = 0x41000080;
        public const uint BUTTON0_PIN = 19;
        public const uint BUTTON0_MASK = 0x80000;

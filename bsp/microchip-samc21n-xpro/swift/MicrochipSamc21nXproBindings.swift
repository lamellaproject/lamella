...
//
// The microchip-samc21n-xpro board bindings as Swift constants, name/value-identical to MicrochipSamc21nXproBindings.g.cs:
// every value below is a generation-time literal derived from the strata. The board's
// facts are stated in board.toml.

public enum MicrochipSamc21nXproBindings {
    // -- identity --

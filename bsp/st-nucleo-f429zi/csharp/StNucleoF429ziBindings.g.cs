...
//
// The st-nucleo-f429zi board bindings (resolved against the stm32f42x chip strata): every value below is a
...
{
    public sealed class StNucleoF429ziBindings
    {
        private StNucleoF429ziBindings() { }

...
namespace Lamella.Boards.St
{
    public sealed class NucleoF429zi
    {
        ...
        public static readonly int BoardModel = StNucleoF429ziBindings.BOARD_MODEL;
        ...
        public static readonly int Led1Pin =
            Stm32f42xGpioDriver.LogicalPin(StNucleoF429ziBindings.LED0_PORT_BASE, StNucleoF429ziBindings.LED0_PIN);

        /// <summary>The blue user LED LD2, ACTIVE HIGH.</summary>
        public static readonly int Led2Pin =
            Stm32f42xGpioDriver.LogicalPin(StNucleoF429ziBindings.LED1_PORT_BASE, StNucleoF429ziBindings.LED1_PIN);

        /// <summary>The red user LED LD3, ACTIVE HIGH.</summary>
        public static readonly int Led3Pin =
            Stm32f42xGpioDriver.LogicalPin(StNucleoF429ziBindings.LED2_PORT_BASE, StNucleoF429ziBindings.LED2_PIN);
        ...
        public static readonly int ButtonPin =
            Stm32f42xGpioDriver.LogicalPin(StNucleoF429ziBindings.BUTTON0_PORT_BASE, StNucleoF429ziBindings.BUTTON0_PIN);

//! GENERATED by lamella-bsp-gen from bsp/microchip-samda1-xpro/board.toml + csp/samda1/ strata -- DO NOT EDIT.
//! Regenerate: cargo run -p lamella-bsp-gen -- gen-family . samda1
//!
//! The microchip-samda1-xpro board bindings as Rust consts, name/value-identical to MicrochipSamda1XproBindings.g.cs:
//! every value below is a generation-time literal derived from the strata.
//! The board's facts are stated in board.toml.

// -- identity --
pub const BOARD_MODEL: u16 = 49;
...
pub const VCP_DRIVER_FAMILY: &str = "samda1-sercom";

// GENERATED by lamella-bsp-gen from bsp/st-stm32f429i-disco/board.toml + csp/stm32f42x/ strata -- DO NOT EDIT.
// Regenerate: cargo run -p lamella-bsp-gen -- gen-family . stm32f42x
//
// The st-stm32f429i-disco board bindings (resolved against the stm32f42x chip strata): every value below is a
...
{
    public sealed class StStm32f429iDiscoBindings
    {
        private StStm32f429iDiscoBindings() { }
        ...
        // -- MEMS_SPI: an st-spi binding descriptor. NO baud emits: an SPI master's rate is a property of the ATTACHED DEVICE, and a binding names a bus. The APB rate is here and the block table states the eight prescaler codes; the driver picks --
        ...
        public const uint LED_GREEN_BANK = 0;
        ...
        public const uint LED_RED_BANK = 0;

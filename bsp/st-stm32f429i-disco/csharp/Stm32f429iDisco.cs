...
namespace Lamella.Boards.St
{
    public sealed class Stm32f429iDisco
    {
        ...
        public static readonly int BoardModel = StStm32f429iDiscoBindings.BOARD_MODEL;

        /// <summary>The green user LED LD3, ACTIVE HIGH.</summary>
        public static readonly int LedGreenPin =
            Stm32f42xGpioDriver.LogicalPin(
                StStm32f429iDiscoBindings.LED_GREEN_PORT_BASE, StStm32f429iDiscoBindings.LED_GREEN_PIN);

        /// <summary>The red user LED LD4, ACTIVE HIGH.</summary>
        public static readonly int LedRedPin =
            Stm32f42xGpioDriver.LogicalPin(
                StStm32f429iDiscoBindings.LED_RED_PORT_BASE, StStm32f429iDiscoBindings.LED_RED_PIN);
        ...
        public static readonly int ButtonPin =
            Stm32f42xGpioDriver.LogicalPin(
                StStm32f429iDiscoBindings.BUTTON_PORT_BASE, StStm32f429iDiscoBindings.BUTTON_PIN);

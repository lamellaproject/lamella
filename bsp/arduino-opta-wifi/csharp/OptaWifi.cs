...
namespace Lamella.Boards.Arduino
{
    public sealed class OptaWifi
    {
        ...
        public static readonly int BoardModel = ArduinoOptaWifiBindings.BOARD_MODEL;
        ...
        public static readonly int Relay1Pin =
            Stm32h7GpioDriver.LogicalPin(ArduinoOptaWifiBindings.RELAY_1_PORT_BASE, ArduinoOptaWifiBindings.RELAY_1_PIN);
        ...
        public static readonly int Relay2Pin =
            Stm32h7GpioDriver.LogicalPin(ArduinoOptaWifiBindings.RELAY_2_PORT_BASE, ArduinoOptaWifiBindings.RELAY_2_PIN);

        /// <summary>Relay output terminal 3.</summary>
        public static readonly int Relay3Pin =
            Stm32h7GpioDriver.LogicalPin(ArduinoOptaWifiBindings.RELAY_3_PORT_BASE, ArduinoOptaWifiBindings.RELAY_3_PIN);

        /// <summary>Relay output terminal 4. Its pin is the LOWEST of the four.</summary>
        public static readonly int Relay4Pin =
            Stm32h7GpioDriver.LogicalPin(ArduinoOptaWifiBindings.RELAY_4_PORT_BASE, ArduinoOptaWifiBindings.RELAY_4_PIN);
        ...
        public static readonly int UserButtonPin =
            Stm32h7GpioDriver.LogicalPin(ArduinoOptaWifiBindings.USER_BUTTON_PORT_BASE, ArduinoOptaWifiBindings.USER_BUTTON_PIN);
        ...
        public static readonly int UserLedPin =
            Stm32h7GpioDriver.LogicalPin(ArduinoOptaWifiBindings.USER_LED_PORT_BASE, ArduinoOptaWifiBindings.USER_LED_PIN);

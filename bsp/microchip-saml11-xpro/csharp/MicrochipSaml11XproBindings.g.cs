// GENERATED by lamella-bsp-gen from bsp/microchip-saml11-xpro/board.toml + csp/saml1x/ strata -- DO NOT EDIT.
// Regenerate: cargo run -p lamella-bsp-gen -- gen-family . saml1x
//
// The microchip-saml11-xpro board bindings (resolved against the saml1x chip strata): every value below is a
...
{
    public sealed class MicrochipSaml11XproBindings
    {
        private MicrochipSaml11XproBindings() { }

        // -- identity --
        public const int BOARD_MODEL = 59;

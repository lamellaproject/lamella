...
//
// The microchip-samha1g16a-xpro board bindings as Swift constants, name/value-identical to MicrochipSamha1g16aXproBindings.g.cs:
// every value below is a generation-time literal derived from the strata. The board's
// facts are stated in board.toml.

public enum MicrochipSamha1g16aXproBindings {
    // -- identity --
    public static let BOARD_MODEL: UInt16 = 50
    ...
    public static let VCP_GCLK_CLKCTRL_VALUE: UInt32 = 0x4015
    public static let VCP_APBC_MASK: UInt32 = 0x8
    public static let VCP_PMUX_TX_REG: UInt32 = 0x4100443D
    public static let VCP_PMUX_TX_MASK: UInt32 = 0xF0
    public static let VCP_PMUX_TX_VALUE: UInt32 = 0x20
    public static let VCP_PMUX_RX_REG: UInt32 = 0x4100443E
    public static let VCP_PMUX_RX_MASK: UInt32 = 0xF
    public static let VCP_PMUX_RX_VALUE: UInt32 = 0x2
    public static let VCP_PINCFG_TX_REG: UInt32 = 0x4100445B
    public static let VCP_PINCFG_RX_REG: UInt32 = 0x4100445C

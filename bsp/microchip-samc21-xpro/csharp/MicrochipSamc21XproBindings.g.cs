...
//
// The microchip-samc21-xpro board bindings (resolved against the samc21 chip strata): every value below is a
...
{
    public sealed class MicrochipSamc21XproBindings
    {
        private MicrochipSamc21XproBindings() { }

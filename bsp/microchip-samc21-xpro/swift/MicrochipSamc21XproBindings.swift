...
//
// The microchip-samc21-xpro board bindings as Swift constants, name/value-identical to MicrochipSamc21XproBindings.g.cs:
// every value below is a generation-time literal derived from the strata. The board's
// facts are stated in board.toml.

public enum MicrochipSamc21XproBindings {
    // -- identity --
    public static let BOARD_MODEL: UInt16 = 53
    ...
    public static let LED0_PORT_BASE: UInt32 = 0x41000000
    public static let LED0_PIN: UInt32 = 15
    public static let LED0_BANK: UInt32 = 0
    public static let LED0_MASK: UInt32 = 0x8000
    public static let LED0_ACTIVE_LOW: UInt32 = 1
    public static let BUTTON0_PORT_BASE: UInt32 = 0x41000000

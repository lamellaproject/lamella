...
//!
//! The microchip-samc21-xpro board bindings as Rust consts, name/value-identical to MicrochipSamc21XproBindings.g.cs:
//! every value below is a generation-time literal derived from the strata.
//! The board's facts are stated in board.toml.

// -- identity --
pub const BOARD_MODEL: u16 = 53;
...
pub const LED0_PORT_BASE: u32 = 0x41000000;
pub const LED0_PIN: u32 = 15;
pub const LED0_BANK: u32 = 0;
pub const LED0_MASK: u32 = 0x8000;
pub const LED0_ACTIVE_LOW: u32 = 1;
pub const BUTTON0_PORT_BASE: u32 = 0x41000000;

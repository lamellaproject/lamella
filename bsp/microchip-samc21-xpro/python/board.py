# GENERATED by lamella-bsp-gen from bsp/microchip-samc21-xpro/board.toml + csp/samc21/ strata -- DO NOT EDIT.
# Regenerate: cargo run -p lamella-bsp-gen -- gen-family . samc21

BOARD = "microchip-samc21-xpro"
BOARD_MODEL = 53
...
FACTS = {
    "vcp": {
        "driver_family": "samc21-sercom",
        "instance": sercom4,
        "sercom_base": 0x42001400,
        "irq": 13,
        "gclk_pchctrl_reg": 0x40001CDC,
        "gclk_pchctrl_value": 0x40,
        "apb_mask_reg": 0x4000081C,
        "apb_mask": 0x20,
        "pmux_reg": 0x410000B5,
        "pmux_pair": 0x33,
        "pmux_tx_reg": 0x410000B5,
        "pmux_tx_mask": 0xF,
        "pmux_tx_value": 0x3,
        "pmux_rx_reg": 0x410000B5,
        "pmux_rx_mask": 0xF0,
        "pmux_rx_value": 0x30,
        "pincfg_tx_reg": 0x410000CA,
        "pincfg_rx_reg": 0x410000CB,
        "txpo": 1,
        "rxpo": 3,
        "baud_115200_osc48m_4mhz": 0x8A0A,
    },
}
...
INSTANCES = {
    "sercom0": {"block": "sercom", "base": 0x42000400, "gclk_core_id": 0x13, "apb_mask_offset": 0x1C, "apb_bit": 0x1, "irq": 0x9},
    "sercom1": {"block": "sercom", "base": 0x42000800, "gclk_core_id": 0x14, "apb_mask_offset": 0x1C, "apb_bit": 0x2, "irq": 0xA},
    "sercom2": {"block": "sercom", "base": 0x42000C00, "gclk_core_id": 0x15, "apb_mask_offset": 0x1C, "apb_bit": 0x3, "irq": 0xB},
    "sercom3": {"block": "sercom", "base": 0x42001000, "gclk_core_id": 0x16, "apb_mask_offset": 0x1C, "apb_bit": 0x4, "irq": 0xC},
    "sercom4": {"block": "sercom", "base": 0x42001400, "gclk_core_id": 0x17, "apb_mask_offset": 0x1C, "apb_bit": 0x5, "irq": 0xD},
    "sercom5": {"block": "sercom", "base": 0x42001800, "gclk_core_id": 0x19, "apb_mask_offset": 0x1C, "apb_bit": 0x6, "irq": 0xE},
    "sercom6": {"block": "sercom", "base": 0x43000000, "gclk_core_id": 0x29, "apb_mask_offset": 0x20, "apb_bit": 0x0, "irq": 0x9},
    "sercom7": {"block": "sercom", "base": 0x43000400, "gclk_core_id": 0x2A, "apb_mask_offset": 0x20, "apb_bit": 0x1, "irq": 0xA},
    "mclk": {"block": "mclk", "base": 0x40000800},
    "gclk": {"block": "gclk", "base": 0x40001C00},
    "porta": {"block": "port", "base": 0x41000000},
    "portb": {"block": "port", "base": 0x41000080},
    "portc": {"block": "port", "base": 0x41000100},
}

PLANS = {
    "osc48m-4mhz": {"default": True, "source": "osc48m", "gclk0_hz": 4000000},
}
...
# own idiom.
DEVICES = {
    "led0": {"kind": "gpio-out", "port_base": 0x41000000, "pin": 15, "bank": 0, "mask": 0x8000, "active_low": True},
    "button0": {"kind": "gpio-in", "port_base": 0x41000000, "pin": 28, "bank": 0, "mask": 0x10000000, "active_low": True},
}

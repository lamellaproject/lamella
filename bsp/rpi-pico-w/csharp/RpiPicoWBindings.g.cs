...
//
// The rpi-pico-w board bindings (resolved against the rp2040 chip strata): every value below is a
...
{
    public sealed class RpiPicoWBindings
    {
        private RpiPicoWBindings() { }

...
//
// The adafruit-feather-m0-wifi board bindings as Swift constants, name/value-identical to AdafruitFeatherM0WifiBindings.g.cs:
// every value below is a generation-time literal derived from the strata. The board's
// facts are stated in board.toml.

public enum AdafruitFeatherM0WifiBindings {
    // -- identity --

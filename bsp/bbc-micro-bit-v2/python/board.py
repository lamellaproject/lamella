...
DEVICES = {
    ...
    "display-row1": {"kind": "gpio-out", "port_base": 0x50000000, "pin": 21, "bank": 0, "mask": 0x200000, "active_low": False},
    "display-row2": {"kind": "gpio-out", "port_base": 0x50000000, "pin": 22, "bank": 0, "mask": 0x400000, "active_low": False},
    "display-row3": {"kind": "gpio-out", "port_base": 0x50000000, "pin": 15, "bank": 0, "mask": 0x8000, "active_low": False},
    "display-row4": {"kind": "gpio-out", "port_base": 0x50000000, "pin": 24, "bank": 0, "mask": 0x1000000, "active_low": False},
    "display-row5": {"kind": "gpio-out", "port_base": 0x50000000, "pin": 19, "bank": 0, "mask": 0x80000, "active_low": False},
    "display-col1": {"kind": "gpio-out", "port_base": 0x50000000, "pin": 28, "bank": 0, "mask": 0x10000000, "active_low": True},
    "display-col2": {"kind": "gpio-out", "port_base": 0x50000000, "pin": 11, "bank": 0, "mask": 0x800, "active_low": True},
    "display-col3": {"kind": "gpio-out", "port_base": 0x50000000, "pin": 31, "bank": 0, "mask": 0x80000000, "active_low": True},
    "display-col4": {"kind": "gpio-out", "port_base": 0x50000300, "pin": 5, "bank": 0, "mask": 0x20, "active_low": True},
    "display-col5": {"kind": "gpio-out", "port_base": 0x50000000, "pin": 30, "bank": 0, "mask": 0x40000000, "active_low": True},
}

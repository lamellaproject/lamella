...
//
// The microchip-saml21-xpro board bindings (resolved against the saml21 chip strata): every value below is a
...
{
    public sealed class MicrochipSaml21XproBindings
    {
        private MicrochipSaml21XproBindings() { }

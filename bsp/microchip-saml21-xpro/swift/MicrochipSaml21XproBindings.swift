...
//
// The microchip-saml21-xpro board bindings as Swift constants, name/value-identical to MicrochipSaml21XproBindings.g.cs:
// every value below is a generation-time literal derived from the strata. The board's
// facts are stated in board.toml.

public enum MicrochipSaml21XproBindings {
    // -- identity --

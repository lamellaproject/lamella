// Lamella.Boards.St.NucleoF439zi -- the ST NUCLEO-F439ZI (STM32F439ZI on the MB1137 carrier).
...
{
    public sealed class NucleoF439zi
    {
        /// <summary>The wire identity this board advertises (lamella_wire::board_model).</summary>
        public static readonly int BoardModel = StNucleoF439ziBindings.BOARD_MODEL;
        ...
        public static readonly int Led1Pin =
            Stm32f42xGpioDriver.LogicalPin(StNucleoF439ziBindings.LED0_PORT_BASE, StNucleoF439ziBindings.LED0_PIN);

        /// <summary>The blue user LED LD2, ACTIVE HIGH.</summary>
        public static readonly int Led2Pin =
            Stm32f42xGpioDriver.LogicalPin(StNucleoF439ziBindings.LED1_PORT_BASE, StNucleoF439ziBindings.LED1_PIN);

        /// <summary>The red user LED LD3, ACTIVE HIGH.</summary>
        public static readonly int Led3Pin =
            Stm32f42xGpioDriver.LogicalPin(StNucleoF439ziBindings.LED2_PORT_BASE, StNucleoF439ziBindings.LED2_PIN);
        ...
        public static readonly int ButtonPin =
            Stm32f42xGpioDriver.LogicalPin(StNucleoF439ziBindings.BUTTON0_PORT_BASE, StNucleoF439ziBindings.BUTTON0_PIN);
        ...
        /// <see cref="NucleoF439zi"/> at all is what arms it, which is why a program constructs the
        /// board first.</summary>

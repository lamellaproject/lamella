...
//
// The microchip-saml22-xpro board bindings as Swift constants, name/value-identical to MicrochipSaml22XproBindings.g.cs:
// every value below is a generation-time literal derived from the strata. The board's
// facts are stated in board.toml.

public enum MicrochipSaml22XproBindings {
    // -- identity --
    public static let BOARD_MODEL: UInt16 = 56
    ...
    public static let VCP_DRIVER_FAMILY: String = "saml22-sercom"
    ...
    public static let VCP_GCLK_PCHCTRL_REG: UInt32 = 0x40001CD0
    ...
    public static let VCP_PMUX_REG: UInt32 = 0x4100613C
    public static let VCP_PMUX_PAIR: UInt32 = 0x33
    public static let VCP_PMUX_TX_REG: UInt32 = 0x4100613C
    public static let VCP_PMUX_TX_MASK: UInt32 = 0xF
    public static let VCP_PMUX_TX_VALUE: UInt32 = 0x3
    public static let VCP_PMUX_RX_REG: UInt32 = 0x4100613C
    public static let VCP_PMUX_RX_MASK: UInt32 = 0xF0
    public static let VCP_PMUX_RX_VALUE: UInt32 = 0x30
    public static let VCP_PINCFG_TX_REG: UInt32 = 0x41006158
    public static let VCP_PINCFG_RX_REG: UInt32 = 0x41006159
    ...
    public static let LED0_PORT_BASE: UInt32 = 0x41006100
    public static let LED0_PIN: UInt32 = 27
    public static let LED0_BANK: UInt32 = 0
    public static let LED0_MASK: UInt32 = 0x8000000
    public static let LED0_ACTIVE_LOW: UInt32 = 1
    public static let BUTTON0_PORT_BASE: UInt32 = 0x41006100
    public static let BUTTON0_PIN: UInt32 = 1
    public static let BUTTON0_BANK: UInt32 = 0
    public static let BUTTON0_MASK: UInt32 = 0x2
